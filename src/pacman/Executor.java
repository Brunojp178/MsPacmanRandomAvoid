...
import pacman.controllers.examples.RandomAvoid;
import pacman.controllers.examples.RandomAvoidWithMaxDist;
...
{	
	...
	public static void main(String[] args)
	{
		...
		Executor exec=new Executor();
                ...
                System.out.println("Random Avoid vs Random Ghost");
                exec.runExperiment(new RandomAvoid(), new RandomGhosts(), numTrials);
                
                System.out.println("Random Avoid vs LEGACY2THERECONING");
                exec.runExperiment(new RandomAvoid(), new Legacy2TheReckoning(), numTrials);
                
                System.out.println("Random Avoid vs Aggressive Ghost");
                exec.runExperiment(new RandomAvoid(), new AggressiveGhosts(), numTrials);
                
                // With "not so random" avoid
                System.out.println("Random With Not so Random Avoid vs Random Ghost");
                exec.runExperiment(new RandomAvoidWithMaxDist(), new RandomGhosts(), numTrials);
                
                System.out.println("Random With Not so Random Avoid vs LEGACY2THERECONING");
                exec.runExperiment(new RandomAvoidWithMaxDist(), new Legacy2TheReckoning(), numTrials);
                
                System.out.println("Random With Not so Random Avoid vs Aggressive Ghost");
                exec.runExperiment(new RandomAvoidWithMaxDist(), new AggressiveGhosts(), numTrials);
		
//		/* run a game in synchronous mode: game waits until controllers respond. */
//		exec.runGame(new RandomAvoid(), new RandomGhosts(), visual,delay);
...
//		exec.runGameTimedRecorded(new RandomAvoid(),new RandomGhosts(),visual,fileName);
